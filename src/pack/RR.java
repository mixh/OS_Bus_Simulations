...
public class RR {
    ...
    public RR(int minExecutionTimeP, int maxExecutionTimeP, int noOfProcess, double IOburst,
    ...
    public void Simulation() {
        try {
            ...
            Event eventRecord;
            int pcbSize;
            PrintStream fileOut = new PrintStream("./RRout.txt");
            ...
            // calculating CPU utilisation by total time spent in the CPU dividing by the
            // end time at which the last process ends
            cpuUtilisation = cputotalUtilisationTime / clock;
            // calculating the average turn around time by the process by dividng the total
            // turn around time by no of process
            avgTurnAroundTime = totalTurnAroundTime / noOfProcess;
            // calculating the average waiting time by the process by dividng the total
            // waiting time by no of process
            avgWaitingTime = totalWaitingTime / noOfProcess;

            // logging the throughput - no of process finsihed per second and other
            // statistics
